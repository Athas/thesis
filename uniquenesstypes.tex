...
rules - the user must either annotate each function with information
about which of the parameters may be aliased by the return value, or
the compiler can possibly deduce it using some sharing inference
algorithm.  As the latter would add a great deal of complexity, and
the former require a language change, I have postponed tackling this
problem until it becomes a problem in practice.
