...
The syntax of \LO{}, as seen on \fref{fig:fo-syntax} and
\fref{fig:fo-syntax-continued}, is heavily inspired by Haskell and
...
array, as described in chapter \ref{chap:uniqueness-types}.
...
scan.  The associativity requirements are not checked by the \LO{}
compiler, and are the responsibility of the programmer.
...
Section \ref{sec:tuple-transformation} contains more information on
the transformation of arrays of tuples.
