...
\newcommand\filtercompose[6]{ (#1,#2) \underset{\texttt{filter}}\circ(#3,#4) \Rightarrow (#5,#6) }
...
non-empty set
\[
\delta=\{p_{b_{i}}\ |\ \exists j.e_{b_{i}}=o_{j}\}, 0 < i \leq m
\]
...
\[
e_{r} \equiv \texttt{let \{$\textrm{if $e_{b_{i}}\in\delta$ then $p_{b_{i}}$ else \texttt{\_} }\ |\ 0 < i \leq k$\} = $e_{a}$ in $e_{b}$}
\]

We will write this entire operation as
\[
...
We will write this entire operation as
\[
\filtercompose{l_{b}}{e_{b_{1}},\ldots,e_{b_{m}}}{l_{a}}{e_{a_{1}},\ldots,e_{a_{n}}}{l_{r}}{e_{r_{1}},\ldots,e_{r_{l}}}
\]
