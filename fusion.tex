...
describes superficially which producer-consumer pairs can be fused, as
...
described in section \ref{sec:fusion-in-l0}.
...
demonstrated on \fref{fig:map-reduce-error}.
...
reduceT(op +, 0, c)
    \emphh{\mymath{\Downarrow}}
reduceT(op +, 0, a, b) \emp{// Type error}
\end{bcolorcode}
...
On \fref{fig:t1t2-1} is shown a small flow graph and highlights
