...
other data-parallel programming languages.  \Cref{sec:future-work}
outlines a number of possible future improvements to \LO{} and the
compiler.  \Cref{sec:conclusion} provides a final summary of the
...
fun [[int]] transpose([[int]] a) =
  \emphh{arrange} a as
    ...
    elem (i,j) => (j,i) \emp{// Put input (j,i) at position (i,j) in output}
\end{colorcode}
...
Yeah, it's pretty good.\fixme{Maybe a bit vague.}
