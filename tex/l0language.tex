...
The \texttt{let-with} construct has some unusual restrictions to
permit in-place modification of the \textit{src} array, as described
in \cref{chap:uniqueness-types}, specifically we track that
...
newly bound array.  We can think of it as similar to array
modification in an imperative language.
